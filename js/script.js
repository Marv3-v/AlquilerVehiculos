...
var Vehiculo = /** @class */ (function (_super) {
    ...
    //
    function Vehiculo(medio, tipo, anio, motor, cantP, color, formato, plazo) {
...
function rentar() {
    var ve = new Vehiculo(localStorage.getItem('medioTransporte'), localStorage.getItem('Aereo'), document.querySelector('#anio').value, document.querySelector('#motor').value, parseInt(document.querySelector('#cant').value), document.querySelector('#color').value, document.querySelector('#formato').value, parseInt(document.querySelector('#plazo').value));
